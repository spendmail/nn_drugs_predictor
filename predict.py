...
def init():
    ...
    return tokenizer, max_news_len, model_lstm, classes


def predict_original_name(name, tokenizer, max_news_len, model_lstm, classes):
...
if __name__ == "__main__":
    ...
    name = sys.argv[1]
    max_value, class_num, predicted_name = predict_original_name(name, tokenizer, max_news_len, model_lstm, classes)
